    ...
    return (
        <div style={{ background: "#2B5D64" }}>
            ...
            <div className="mobile-message-container">
                <span className="mobile-message">Your mobile device is a fine piece of equipment, but Scolded.com requires a proper desktop computer because we say so.</span>
            </div>
...
const twitterIcon = (
    <svg id="twitter-footer-icon" width="59px" height="48px" viewBox="0 0 32 26" version="1.1" xmlns="http://www.w3.org/2000/svg"
...
const facebookIcon = (
    < svg id="facebook-footer-icon" width="48px" height="48px" viewBox="0 0 27 27" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" >
